...
<body>
  ...
  <script>
    ...
    async function submitIntake(isRecruiter) {
      ...
      try {
        await fetch("https://tylerjanczak-github-io.vercel.app/api/chat", {
          method: "POST",
          mode: "cors",
          cache: "no-store",
        ...
        // Non-critical — proceed to chat regardless.
      }
      ...
      window.location.href = "https://bridges.tylerjanczak.com/";
    }
