(() => {
  ...
  widget.innerHTML = `
    ...
    >
      ...
      <footer class="tyler-ai-footer">
        ...
        <p class="tyler-ai-privacy">
          Conversations may be recorded for quality, system improvement, and personalization.
        </p>
      </footer>
    </div>
  ...
  addAssistantMessage(
    "Hi, I'm Tyler AI. I can answer complex questions, highlight relevant experience or projects, or point you to the right section of the site."
  );
  ...
  form.addEventListener("submit", async (event) => {
    ...
    if (question.length > 500) {
      addAssistantMessage(
        "Please shorten your question to fewer than 500 characters.",
        "error"
      );
      return;
    }
